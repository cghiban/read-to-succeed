...
// WrapMiddleware is a convenience wrapper for Apply that accepts an http.HandlerFunc
...
//   ApplyFn(Demo, ...)
//
func WrapMiddleware(fn http.HandlerFunc, mws ...func(http.Handler) http.HandlerFunc) http.Handler {
	return Apply(fn, mws...)
}
